...
export function Footer() {
  return (
    <footer className="relative w-full bg-footer-bg p-10 ">
            ...
            {LINKS.map(({ title, items,navLink }) => (
              ...
              <ul key={title}>
                ...
                <Typography
                  variant="small"
                  color="blue-gray"
                  className="mb-3 opacity-40 text-white md:text-2xl  font-bold"
                >
                  {title}
                </Typography>
                {items.map((link) => (
                  <li key={link}>
                    ...
                    <Typography
                      ...
                      href="#"
                      color="gray"
                      className="py-1.5 font-normal transition-colors hover:text-red-800 text-white text-sm "
                    >
                      {link}
                    </Typography>
                    </NavLink>
